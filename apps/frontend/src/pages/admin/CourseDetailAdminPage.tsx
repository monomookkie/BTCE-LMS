  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-slate-100 bg-white px-4 py-3 hover:border-slate-200">
      ...
      {/* Actions — url สำหรับ LINK/VIDEO, signedUrl สำหรับ PDF/IMAGE/DOC (ไฟล์อัปโหลด)
          DOC (.doc/.docx) จะดาวน์โหลดแทนที่จะเปิดดู — บราวเซอร์ไม่มี viewer ในตัวให้ไฟล์ Word เลย
          (ลองฝัง Google Docs Viewer แล้วแต่ไม่เสถียร โดนถอนออก ดู commit ก่อนหน้า) เป็นพฤติกรรม
          มาตรฐานเดียวกับทั้งวงการเว็บ ไม่ใช่บั๊ก */}
